...
<head>
    ...
    <link rel="icon" href="#">
    <title>FORK N SPOON Restaurant</title>
    <!-- Bootstrap core CSS -->
                ...
                <div class="row bottom-footer">
                    <div class="container">
                        <div class="row">
                            ...
                            <h5>Address</h5>
                            <p>mota varchha near by sai complex,surat</p>
                                <h5>Phone: <a href="tel:+917041380632">+917041380632</a></h5>
                            </div>
                ...
                <div class="modal-body cart-addon">
                    ...
                    <div class="food-item">
                        <div class="row">
                            ...
                            <!-- end:col -->
                            <div class="col-xs-6 col-sm-2 col-lg-2 text-xs-center"> <span class="price pull-left">₹ 200</span></div>
                            <div class="col-xs-6 col-sm-4 col-lg-4">
                                <div class="row no-gutter">
                                    <div class="col-xs-7">
                    ...
                    <div class="food-item">
                        <div class="row">
                            ...
                            <!-- end:col -->
                            <div class="col-xs-6 col-sm-2 col-lg-2 text-xs-center"> <span class="price pull-left">₹ 180</span></div>
                            <div class="col-xs-6 col-sm-4 col-lg-4">
                                <div class="row no-gutter">
                                    <div class="col-xs-7">
                    ...
                    <div class="food-item">
                        <div class="row">
                            ...
                            <!-- end:col -->
                            <div class="col-xs-6 col-sm-2 col-lg-2 text-xs-center"> <span class="price pull-left">₹ 140</span></div>
                            <div class="col-xs-6 col-sm-4 col-lg-4">
                                <div class="row no-gutter">
                                    <div class="col-xs-7">
